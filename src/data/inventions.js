export const inventionData = {
  center: {
    ...
    summary: "22 patented inventions forming a complete visual product recognition system for grocery-scale self-checkout, covering enrollment, detection, and latency optimization.",
    condensed: {
      accomplishes: [
      ...
      techAreas: [
        {
          ...
          inventions: [
            ...
            {
              id: "single-shot-3d",
              label: "Single Shot 3D Modelling from 2D Image",
              shortLabel: "Single Shot 3D Modelling",
              condensed: {
                accomplishes: [
